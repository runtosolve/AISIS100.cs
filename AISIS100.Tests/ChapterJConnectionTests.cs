...
public class ChapterJConnectionTests
{
    ...
    {
        var output = new Output();
        var Pnv = AISIS100.ChapterJConnections.EqJ4_3_1__2(0.0566, 0.190, 65000.0, output);
        
        var expected = 1887.0;  // AISI D110-16, p1-31
        var actual = Pnv;
        Assert.That(actual, Is.EqualTo(expected).Within(1.0).Percent);
        Assert.That(output.GetResult("Pnv").Equation, Is.EqualTo("Eq.J4.3.1-2"));
    }
    ...
    {
        var output = new Output();
        var Pnv = AISIS100.ChapterJConnections.EqJ4_3_1__3(0.0451, 0.190, 45000.0, output);
        
        var expected = 1041.0;  // AISI D110-16, p1-31
        var actual = Pnv;
        Assert.That(actual, Is.EqualTo(expected).Within(1.0).Percent);
        Assert.That(output.GetResult("Pnv").Equation, Is.EqualTo("Eq.J4.3.1-3"));
    }
    ...
    {
        var output = new Output();
        var Pnv = AISIS100.ChapterJConnections.EqJ4_3_1__4(0.0566, 0.190, 65000.0, output);
        
        var expected = 1887.0;  // AISI D110-16, p1-31
        var actual = Pnv;
        Assert.That(actual, Is.EqualTo(expected).Within(1.0).Percent);
        Assert.That(output.GetResult("Pnv").Equation, Is.EqualTo("Eq.J4.3.1-4"));
    }
    ...
    {
        var output = new Output();
        var Pnv = AISIS100.ChapterJConnections.EqJ4_3_1__5(0.0451, 0.190, 45000.0, output);
        
        var expected = 1041.0;  // AISI D110-16, p1-31
        var actual = Pnv;
        Assert.That(actual, Is.EqualTo(expected).Within(1.0).Percent);
        Assert.That(output.GetResult("Pnv").Equation, Is.EqualTo("Eq.J4.3.1-5"));
    }
    ...
    {
        var output = new Output();
        var Pnot = AISIS100.ChapterJConnections.EqJ4_4_1__1(0.0451, 0.190, 45000.0, "inches", output);
    ...
    {
        var output = new Output();
        var Pnov = AISIS100.ChapterJConnections.EqJ4_4_2__1(0.0566, 0.400, 65000.0, output);
